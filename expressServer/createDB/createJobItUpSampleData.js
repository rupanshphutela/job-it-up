...
jobPosterCollection.insert(
{
	...
	companyLogo: "http://localhost:8080/images/Soft_tester.png",
	Overview: "We enable leading companies to accelerate their business intelligence and analytics initiatives.",
...
jobPosterCollection.insert(
{
	...
	companyLogo: "http://localhost:8080/images/Dental.png",
...
jobPosterCollection.insert(
{
	...
	companyLogo: "http://localhost:8080/images/Maths.png",
